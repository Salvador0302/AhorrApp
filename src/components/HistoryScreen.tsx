...
import { Calendar, TrendingUp, TrendingDown, DollarSign, Zap, ArrowLeft, Filter } from 'lucide-react';
    ...
    <div className="p-4 space-y-6">
      ...
      <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/10 p-4">
        ...
        <div className="h-32 flex items-end justify-between gap-1">
          {historyData.slice().reverse().map((record, index) => {
            ...
            <div key={record.id} className="bg-white/10 backdrop-blur-md rounded-xl border border-white/10 p-4">
              ...
              <div className="grid grid-cols-3 gap-3 mb-3">
                ...
                <div className="bg-white/5 rounded-lg p-2">
                  ...
                  <p className="text-white font-semibold text-sm">${record.amount}</p>
                </div>
                
                <div className="bg-white/5 rounded-lg p-2">
                  <p className="text-white/60 text-xs">Ahorro</p>
                  <p className="text-green-400 font-semibold text-sm">${record.savings}</p>
                </div>
              </div>
      ...
      <div className="bg-gradient-to-r from-blue-500/10 to-green-500/10 backdrop-blur-md rounded-xl border border-white/10 p-4">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <p className="text-white font-semibold">${totalPaid.toFixed(2)}</p>
          </div>
          <div>
            <p className="text-white/70">Total ahorrado</p>
            <p className="text-green-400 font-semibold">${totalSavings.toFixed(2)}</p>
          </div>
        </div>
